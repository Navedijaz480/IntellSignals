const IntroductiontoAI = () => {
    return ( 
        ...
        <div className='relative -top-36 w-4/5 bg-opacity-0 flex flex-col items-center gap-4'>
          <h2 className='text-[30px] font-bold text-black'>Introduction to AI and ML with Application and Future</h2>
          <h3 className='text-2xl  font-semibold text-gray-700'>Massive, Decentralized Connectivity</h3>
          ...
          <button className="mt-4 rounded-xl px-6 py-4 overflow-hidden relative group cursor-pointer border-2 font-semibold bg-gradient-to-r from-orange-400 to-red-500 text-black ">
        ...
        <div className='pb-4 z-1 px-4 w-full max-w-6xl flex flex-col md:flex-row md:items-stretch items-center gap-x-12 gap-y-7 mb-20'>
          <div className='flex flex-col bg-gradient-to-b from-green-200 to-green-300 shadow p-8 rounded-lg w-3/4 md:w-1/3 gap-6 hover:scale-105 transition duration-300'>
            <h3 className='text-gray-900 text-xl font-bold'>AN OPEN ALTERNATIVE</h3>
          ...
          <div className=' flex flex-col  bg-gradient-to-b from-blue-200 to-blue-300 shadow p-8 rounded-lg w-3/4 md:w-1/3 gap-6 hover:scale-105 transition duration-300'>
            <h3 className='text-gray-900 text-xl font-bold'>SCALABLE & AFFORDABLE</h3>
          ...
          <div className='flex flex-col bg-gradient-to-b from-purple-200 to-purple-300 shadow p-8 rounded-lg w-3/4 md:w-1/3 gap-6 hover:scale-105 transition duration-300'>
            <h3 className='text-gray-900 text-xl font-bold'>LORAWAN-COMPATIBLE</h3>
