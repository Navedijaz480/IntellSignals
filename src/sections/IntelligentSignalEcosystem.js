    ...
    return ( 
        ...
        <div className='flex flex-col lg:flex-row w-full max-w-7xl lg:items-stretch items-center py-8'>
          ...
          <div className='flex lg:w-1/2 w-4/5 p-5 mt-3 lg:-mt-0   flex-col rounded-xl bg-black bg-opacity-40 hover:bg-opacity-50  gap-8'>
            {/* <h2 className='text-3xl font-semi-bold text-white'>Intelligent Signal Ecosystem</h2> */}
            <h2 className=' text-4xl font-semibold'>
            <span className='text-orange-400'>Intelligent Signal </span>
            <span className='text-red-500'>Ecosystem</span> </h2>



            <p className='text-md text-gray-100'>Community-Centric: Intelligent Signals believes the community is the key to success, especially in Web3.
